...
const Home = ({ addToCart }) => {
  ...
  return (
    <main style={{ background: "#f7f7fa", minHeight: "100vh", color: "#222", padding: "2rem" }}>
      <section>
        ...
        <div style={{
          ...
          {categories.map(cat => (
            <div
              ...
              style={{
                background: selectedCategory === cat.name ? "#7c1c4b" : "#fff",
                color: selectedCategory === cat.name ? "#fff" : "#7c1c4b",
                borderRadius: "10px",
                ...
                fontSize: "1.1rem",
                cursor: "pointer",
                border: selectedCategory === cat.name ? "2px solid #7c1c4b" : "2px solid #eee",
                transition: "all 0.2s"
              }}
            >
              {cat.name}
        ...
        {loading ? (
          ...
          <div style={{
            ...
            {filteredProducts.length === 0 ? (
              <div style={{ gridColumn: "1/-1", textAlign: "center", color: "#7c1c4b" }}>
